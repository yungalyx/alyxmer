...
contract UniversalChannelPacketTest is Base, IbcMwEventsEmitter {
    ...
    function register_mw1() internal returns (uint256) {
        ...
        // change daonft's default middleware to mw1, which sits on top of UniversalChannel MW
        vm.startPrank(address(eth1));
        v1.daonft.setDefaultMw(address(v1.mw1));
        ...
        v2.daonft.setDefaultMw(address(v2.mw1));
        // register mw1 as the only middleware in the stack
    ...
    function register_mw1_mw2() internal returns (uint256) {
        ...
        // change daonft's default middleware to mw1, which calls mw2, then UniversalChannel MW
        vm.startPrank(address(eth1));
        v1.daonft.setDefaultMw(address(v1.mw1));
